...
PatchOffset g_660_offsets = {
	...
	.pops_patch = {
		.decomp = {
			...
			{ 0xDEADBEEF, 0xDEADBEEF }, // 07G
			{ 0xDEADBEEF, 0xDEADBEEF }, // unused
			{ 0xDEADBEEF, 0xDEADBEEF }, // 09G
		},
		.ICON0SizeOffset = {
			0x00036D50, // 01G
			0x00037D8C, // 02G
